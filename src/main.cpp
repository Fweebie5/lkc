...
uint256 hashGenesisBlock("0x0000050770d31f899ab9e69a853378c5522c278bfc29133d7cb0cebf5fff4b1b");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // LinkedCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "LinkedCoin Signed Message:\n";
...
{
    // LinkedCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // LinkedCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "LinkedCoin Genesis Block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xeaa12dda35ffcab1f37f335183f4807eae6f1f6e61fe8e94652e855b65909266"));
...
unsigned char pchMessageStart[4] = { 0xfc, 0xcc, 0xb3, 0xd7 }; // LinkedCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LinkedCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LinkedCoinMiner : ProcessBlock, block not accepted");
    }
